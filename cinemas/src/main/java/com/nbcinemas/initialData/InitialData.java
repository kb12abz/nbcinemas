...
public class InitialData {
	...
	public InitialData(){
		...
		films.add(f1);
		Film f2 = new Film(2, "Fantastic Beasts", 4, "It’s 1926, and 'Magizoologist' Newt Scamander (Eddie Redmayne) arrives in New York City for a meeting with the Magical Congress of the United States of America. He doesn’t arrive alone, however – in his magical suitcase live a menagerie of dangerous creatures. But when the beasts escape, officials from the Magical Congress send the wizarding authorities after Newt, as the peaceful relationship between magic people and Muggles comes under threat. ", "img/fantasticCover.jpg", "img/fantasticBanner.jpg", new Date(116,10,19));
		films.add(f2);
